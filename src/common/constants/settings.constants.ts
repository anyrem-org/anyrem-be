...
const shortcuts = (value: unknown) => {
  ...
  return ["search", "create"].every(
    (key) => typeof input[key] === "string" && input[key].length > 0,
  );
};
export const isValidTime = (value: unknown) =>
...
export const SETTING_REGISTRY = [
  ...
  {
    type: SETTING_TYPES.APPEARANCE,
    key: SETTING_KEYS.APPEARANCE.SHOW_ACTIVITY_PANEL,
    defaultValue: true,
    validate: bool,
    secret: false,
  },
  ...
  {
    type: SETTING_TYPES.QUICK_ACCESS,
    key: SETTING_KEYS.QUICK_ACCESS.SHORTCUTS,
    defaultValue: {
  ...
  {
    type: SETTING_TYPES.RECAP,
    key: SETTING_KEYS.RECAP.ENABLED,
    defaultValue: true,
    validate: bool,
    secret: false,
  },
  {
    type: SETTING_TYPES.RECAP,
    key: SETTING_KEYS.RECAP.DELIVERY_TIME,
    defaultValue: "22:00",
  ...
  {
    type: SETTING_TYPES.RECAP,
    key: SETTING_KEYS.RECAP.EMAIL_ENABLED,
    defaultValue: true,
    validate: bool,
    secret: false,
  },
  {
    type: SETTING_TYPES.RECAP,
    key: SETTING_KEYS.RECAP.TELEGRAM_ENABLED,
    defaultValue: false,
    validate: bool,
    secret: false,
  },
  {
    type: SETTING_TYPES.TELEGRAM,
    key: SETTING_KEYS.TELEGRAM.BOT_TOKEN,
    defaultValue: null,
    validate: string,
    secret: true,
  },
  {
    type: SETTING_TYPES.TELEGRAM,
    key: SETTING_KEYS.TELEGRAM.CHAT_ID,
    defaultValue: null,
    validate: string,
    secret: true,
  },
  {
    type: SETTING_TYPES.TELEGRAM,
    key: SETTING_KEYS.TELEGRAM.BOT_USERNAME,
    defaultValue: null,
    validate: string,
    secret: false,
  },
  {
    type: SETTING_TYPES.TELEGRAM,
    key: SETTING_KEYS.TELEGRAM.VERIFIED_AT,
    defaultValue: null,
    validate: string,
    secret: false,
  },
...
export const SETTING_DEFAULTS = Object.fromEntries(
  SETTING_REGISTRY.map((x) => [`${x.type}.${x.key}`, x.defaultValue]),
);
export const settingEntry = (type: string, key: string) =>
  SETTING_REGISTRY.find((x) => x.type === type && x.key === key);
